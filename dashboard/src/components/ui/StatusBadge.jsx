...
const MAP = {
  ...
  UPTREND: { bg: "rgba(34,197,94,0.16)", color: "var(--profit)", dot: "var(--profit)", pulse: "livePulse 1.5s infinite" },
  DOWNTREND: { bg: "rgba(239,68,68,0.16)", color: "var(--loss)", dot: "var(--loss)" },
  SIDEWAYS: { bg: "rgba(245,158,11,0.16)", color: "var(--warning)", dot: "var(--warning)" },
  UNKNOWN: { bg: "rgba(107,114,128,0.16)", color: "var(--text-secondary)", dot: "var(--text-secondary)" },
};
